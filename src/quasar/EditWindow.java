 ...
 * Created: May 28, 2013
 * 
 * use a SpringLayout for this GUI element
 * http://docs.oracle.com/javase/tutorial/uiswing/examples/layout/SpringFormProject/src/layout/SpringForm.java
 */
...
public class EditWindow extends JFrame
{
	...
	public EditWindow()
	{
		...
		getContentPane().add(propertiesLabel);
		...
		getContentPane().add(keywordsTextField);
